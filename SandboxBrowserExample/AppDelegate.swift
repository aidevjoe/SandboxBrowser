...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        do {
            try "Hello world".write(toFile: plistpath!, atomically: true, encoding: .utf8)
            try "Hello world".write(toFile: pngpath!, atomically: true, encoding: .utf8)
            try "Hello world".write(toFile: dbpath!, atomically: true, encoding: .utf8)
        } catch {
